...
public class BitVector
{
    ...
    {
        bits |= (1 << index); // something OR 1 is 1
    }
    ...
    {
        bits &= ~(1 << index); // something AND 0 is 0
    }
    ...
    {
        bits ^= (1 << index); // something XOR 1 is !something
    }
    ...
    {
        return (index < 32) && ((bits & (1 << index)) != 0); // 1 AND 1 is 1
    }
    ...
    {
        return (index >= 32) || ((bits & (1 << index)) == 0); // 0 AND 1 is 0
    }
